...
def upgrade():
    ...
    with op.batch_alter_table("academic_info", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column("school_account_number", sa.String(50), nullable=True)
        )
    ...
    with op.batch_alter_table("academic_info", schema=None) as batch_op:
        batch_op.alter_column(
            "institution_name", existing_type=sa.String(255), nullable=False
        )
        batch_op.alter_column(
            "education_level", existing_type=sa.String(50), nullable=False
        )
        batch_op.alter_column(
            "school_account_number", existing_type=sa.String(50), nullable=False
        )
        batch_op.alter_column("bank_name", existing_type=sa.String(100), nullable=False)
        batch_op.alter_column(
            "bank_branch", existing_type=sa.String(100), nullable=False
        )
