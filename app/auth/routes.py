...
def register():
    ...
    if form.validate_on_submit():
        try:
            ...
            existing_phone = Profile.query.filter_by(phone_number=form.phone_number.data).first()
            if existing_phone:
            ...
            try:
                ...
                flash('Registration successful but failed to send verification email. Please try again later.', 'warning')
                print(f"Email error: {str(e)}")
